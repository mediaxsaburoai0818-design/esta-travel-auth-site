...
export const metadata: Metadata = {
  ...
  description: "Polityka prywatnosci serwisu ESTA Online. Informacje o przetwarzaniu danych osobowych.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-gray-600 leading-relaxed text-sm">
        ...
        <p>
          ...
          danych osobowych uzytkownikow serwisu ESTA Online. Szanujemy
