...
export default function ApplyPage() {
  ...
  const selectClass =
    "w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-[#022444] bg-white";

  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1
        className="text-3xl md:text-4xl font-bold text-[#022444] mb-2"
      ...
      <div className="mb-8">
        ...
        <div className="w-full bg-gray-200 rounded-full h-1.5">
          <div
            className="bg-[#022444] h-1.5 rounded-full transition-all"
            style={{
      ...
      <div className="bg-white border border-gray-200 rounded p-6 md:p-8">
        <h2 className="text-xl font-bold text-[#022444] mb-6">
          {stepTitles[step]}
        </h2>
        ...
        {step === 3 && (
          <div className="space-y-4">
            <h3 className="font-bold text-[#022444] text-sm border-b border-gray-200 pb-2">
            ...
            <h3 className="font-bold text-[#022444] text-sm border-b border-gray-200 pb-2 pt-4">
              Kontakt alarmowy
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
        ...
        {step === 5 && (
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded p-6 text-center hover:border-[#022444] transition cursor-pointer">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded p-4">
                <h3 className="font-bold text-[#022444] text-sm mb-3">
                  Dane paszportowe
                </h3>
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
          {step > 0 ? (
            <button
              onClick={prevStep}
              className="text-gray-600 hover:text-[#022444] font-medium text-sm transition"
            >
              &larr; Wstecz
            </button>
          ) : (
          ...
          {step < stepTitles.length - 1 ? (
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded font-bold text-sm transition ${
                agreed
                  ? "bg-[#8d1812] hover:bg-[#6d120e] text-white border-[3px] border-double border-[#6d120e]"
